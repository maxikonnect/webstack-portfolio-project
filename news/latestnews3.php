            ...
            <section class="latestnews">
                <header class="header">
                    ...
                    <div class="latest-header-two">
                        <div class="nextprev">
                            <a class="fas fa-angle-double-left" href="./latestnews2.php"> prev</a>
                            <a class="disabled fas fa-angle-double-right" href=""> next</a>
                        </div>
                        <div class="social">
                            <p>share:</p>
                ...
                <div class="text-container">
                    <div class="text-row">
                        <img src="../Assets/images/news/news1.png" width="200" height="150" alt="latestnews">
                        ...
                        <p>The Ghana National Association of Teachers (GNAT), the National Association of Graduate Teachers (NAGRAT) and the Coalition of Concerned Teachers Ghana (CCT-GH) said the lack of textbooks, overcrowded classrooms, delay in payment of capitation grant, increase in workload and the non-payment of responsibility allowances were some of the issues.</p>
