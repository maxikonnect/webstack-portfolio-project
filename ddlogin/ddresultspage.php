...
?>
<?php 
$pageTitle = "DD Check Results - PassOneTouch";
        ...
        <header class="loggedheader" id="loggedheader">
            <div class="header-container">
              <div class="header-container-sub">
                ...
                <div class="logo"><a href="./ddhome.php">passonetouch</a></div>
              </div>
            </div>
          ...
          <main>
            ...
            <section class="scores">
                <div class="containerscores">
                    <div class="rowscores">
                        <a class="resultslink" href="../quizhtml/DD/ddresult1.html">test 1 results</a>
                        <a class="resultslink" href="../quizhtml/DD/ddresult2.html">test 2 results</a>
                        <a class="resultslink" href="../quizhtml/DD/ddresult3.html">test 3 results</a>
